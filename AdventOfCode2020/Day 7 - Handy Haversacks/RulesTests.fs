...
dotted black bags contain no other bags."
        ...
        let bags = processRules rules "shiny gold"

        bags |> should equal [| "bright white"; "dark orange"; "light red"; "muted yellow" |]

    [<Fact>]
    member __.``Puzzle Input - Part I`` () =
        let rules = "wavy green bags contain 1 posh black bag, 1 faded green bag, 4 wavy red bags.
...
vibrant cyan bags contain 5 vibrant plum bags."
        ...
        output.WriteLine("Bags {0}", bags |> Array.length)
...
dark violet bags contain no other bags."
        ...
        let bags = countBags rules "shiny gold"

        bags |> should equal 126
